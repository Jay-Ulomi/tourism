                                    ...
                                    <tbody>
                                        <tr>
                                            @foreach ($hotels as $index => $hotel)
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.edit',$hotel->id) }}" class="icon-link"><i class="fas fa-pencil-alt edit"></i></a>
                                                    <a href="#" class="delete-link" data-hotel-id="{{ $hotel->id }}">
