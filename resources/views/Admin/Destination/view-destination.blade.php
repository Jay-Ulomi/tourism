                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">All Destination</h6>
                                    ...
                                    <tbody>
                                        <tr>
                                            @foreach ($destinations as $index => $destination)
                                                ...
                                                <td>
                                                    <a href="{{ route('edit-admin-destination',$destination->id) }}" class="icon-link"><i class="fas fa-pencil-alt edit"></i></a>
                                                    <a href="#" class="delete-link" data-destination-id="{{ $destination->id }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function deleteDestination(destinationId) {
                ...
                fetch(`/delete-admin-destination/${destinationId}`, {
                    method: 'DELETE',
                    headers: {
