                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">All Restaurant</h6>
                                    ...
                                    <tbody>
                                        <tr>
                                            @foreach ($restaurants as $index => $restaurant)
                                                ...
                                                <td>
                                                    <a href="{{ route('edit-admin-restaurant',$restaurant->id) }}" class="icon-link"><i class="fas fa-pencil-alt edit"></i></a>
                                                    <a href="#" class="delete-link" data-restaurant-id="{{ $restaurant->id }}">
